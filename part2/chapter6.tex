...
\begin{table}[htbp]
  ...
  \begin{minipage}[t]{0.52\textwidth}
    \raggedright
    \vspace{0pt}
    \caption{\textcolor{red}{運動データごとの表情エントリの数}}
...
\begin{figure}[H]    
  ...
  \caption{\textcolor{red}{《ブふぁああーーー(A3)》と《へふいへ(A19)》の表情図形}}          
...
\begin{figure}[H]
  ...
  \end{center}
  \end{continuousphoto}
  \caption{\textcolor{red}{《ンーコツコツンー(A7)》の表情図形}}
...
\begin{figure}[H]
  ...
  \end{center}
  \end{continuousphoto}
  \caption{\textcolor{red}{《フリフリ(A10)》の表情図形}}
...
\begin{figure}[H]    
  ...
  \caption{\textcolor{red}{《あいやっ(B20)》（上段）と《ぼぶわっ！(B21)》（下段）の表情図形}}          
...
\textcolor{blue}{抽出の結果、対象者A〜Dが作成した全83エントリのうち57エントリがモチーフを有し、57エントリから計87語のモチーフ語が得られた。}
