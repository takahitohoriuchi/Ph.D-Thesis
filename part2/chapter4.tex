...
% プリアンブル例：\usepackage{tabularx,booktabs,subcaption,array}

\newcommand{\marker}[2]{#1 & #2 \\}

\begin{table*}[t]
  \centering
  \caption{HJ-Playground計測で用いたマーカ一覧（B/C 各24箇所）}
  \label{tab:markers_side_by_side_simple}
