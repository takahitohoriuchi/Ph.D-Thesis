...
これを\textbf{表情図形}と呼ぶ。
ユーザには、作図した表情図形を鑑賞しながら、感得している表情をオノマトペで命名し、そのさなかで生まれる問いをからだメタ認知でからだメタ認知することを促す。


なぜ『HJ-Playground』と命名したのか。
「HJ」は「表情」の略である。
「Playground」としたのは、前段落で説明したかたちで、ユーザが「表情」と主体的にかかわり、遊ぶからである。
これは\ref{subsec:toy}項の「トイ（おもちゃ）で戯れる」という思想とも通じているわけであるが、本アプリは「遊ぶもの（おもちゃ）」というよりは「遊び場」というほうがふさわしい（そういうユーザ体験になっている）と考え、HJ-playgroundと命名した。



本章各節で、各種仕様とその意義を説明するが、
なによりまずは、以下の動画を観てほしい。
\href{https://takahitohoriuchi.github.io/hj-playground_gallery/oldman.html}{https://takahitohoriuchi.github.io/hj-playground_gallery/oldman.html}
この動画は、次章でも登場するストリートダンサーである対象者Aの踊り動作「oldman」の、
本アプリでのデフォルト状態の再生像である。
ユーザは映像にあるこうした点群をもちいて、表情図形を作図することになる。
本章各節での説明も、この動画を事例にしつつ説明する。


私はこのoldmanの動きのなかにある身体に、どういう「表情」（点群のみのデフォルト状態で）をみてとるかを簡単に語っておく。
意識のもちようで2種類の「表情」、「グイン」と「ヒョイッ」が立ち現れる。
上半身あたりに意識を及ばせたとき「グイン」が立ち現れる。
まるでフラフープを静止状態から回し始めるような力感があり、このとき体感部
下半身あたりに意識を及ばせてみると「ヒョイッ」が立ち現れる。
下半身全体がひとつの重めの物体のようであり、「ほんとうはその場にとどまっていたいけど引っ張られてしょうがなく最小限だけ移動してあげる」、といった省エネでやや怠惰な印象もあるような、「表情」である。
「腰が重い」という日本語がすかさず想起される。
...
\begin{description}
  ...
  その表情エントリの、「表情オノマトペ」と「からだメタ認知」（後述）と、その表情エントリの開始/終了フレームを設定するスライダと、その表情エントリの保存ボタン・コピーボタン・削除ボタンが並ぶ。
...
\autoref{table:presetpatterns}・\autoref{fig:presetpatterns1}・\autoref{fig:presetpatterns2}には、
実際の動画を参照するリンクも付けてある。各パタンの名前や画像をクリックして動画を観て確認してほしい。
...
\begin{figure}[H]    
  ...
  \begin{center}    
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/oldman.html}{\includegraphics[width=\linewidth]{./images/hojosen_pattern_a.pdf}}
  \end{center}
  \vspace{-1.6em}    
  
  \begin{center}    
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/pattern_sankakkei.html}{\includegraphics[width=\linewidth]{./images/hojosen_pattern_b.pdf}}
  \end{center}
  \vspace{-1.6em}    
  
  \begin{center}    
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/pattern_rinkaku.html}{\includegraphics[width=\linewidth]{./images/hojosen_pattern_c.pdf}}
  \end{center}
  \vspace{-1.6em}    
  
  \begin{center}    
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/pattern_wagomu.html}{\includegraphics[width=\linewidth]{./images/hojosen_pattern_d.pdf}}
  \end{center}
  \vspace{-1.6em}    
  
  \begin{center}    
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/pattern_uzumaki.html}{\includegraphics[width=\linewidth]{./images/hojosen_pattern_e.pdf}}
  \end{center}
  \vspace{-1.6em}    
  
  \begin{center}    
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/pattern_kizaminori.html}{\includegraphics[width=\linewidth]{./images/hojosen_pattern_f.pdf}}
  \end{center}        
  \vspace{-1.6em}    

  \begin{center}    
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/pattern_yokoame.html}{\includegraphics[width=\linewidth]{./images/hojosen_pattern_g.pdf}}
  \end{center}

  \caption{備え付け補助線パタン一覧（その1）}          
  \label{fig:presetpatterns1}
\end{figure}
...
\begin{figure}[H]    
  ...
  % 外接円+デフォルト
  \begin{center}    
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/pattern_ame.html}{\includegraphics[width=\linewidth]{./images/hojosen_pattern_h.pdf}}
  \end{center}
  \vspace{-1.6em}    
  % 内接円+デフォルト
  \begin{center}    
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/pattern_randomchikai.html}{\includegraphics[width=\linewidth]{./images/hojosen_pattern_i.pdf}}
  \end{center}
  \vspace{-1.6em}    
  % 内外接円+デフォルト
  \begin{center}    
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/pattern_randomtooi.html}{\includegraphics[width=\linewidth]{./images/hojosen_pattern_j.pdf}}
  \end{center}
  \vspace{-1.6em}    
  % 注視点からの円
  \begin{center}    
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/pattern_kawa.html}{\includegraphics[width=\linewidth]{./images/hojosen_pattern_k.pdf}}
  \end{center}
  \vspace{-1.6em}    
  % 注視点からの円
  \begin{center}    
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/pattern_hitofudeyoko.html}{\includegraphics[width=\linewidth]{./images/hojosen_pattern_l.pdf}}
  \end{center}
  \vspace{-1.6em}  
  % 大三角
  \begin{center}    
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/pattern_hitofudetate.html}{\includegraphics[width=\linewidth]{./images/hojosen_pattern_m.pdf}}
  \end{center}          
  \caption{備え付け補助線パタン一覧（その2）}          
  \label{fig:presetpatterns2}
\end{figure}
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{>{\bfseries}lX}
    ...
    パタン名 & 説明 \\
    \hline
    % \href{https://docs.google.com/spreadsheets/d/1Cb4Z2Icadg7oncfOc6T3CEFZgEmK-RriXHv0mI1atRY/edit?gid=461436636#gid=461436636}{三角形で埋める} & 点群のあいだが三角形で埋め尽くされるようにする。三角形群は、なるべく多くが鋭角三角形になるように、かつ、線分どうしが交わらないようにする。ドロネー三角形のアルゴリズムと同様である。 \\
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/pattern_sankakkei.html}{三角形で埋める} & 点群のあいだが三角形で埋め尽くされるようにする。三角形群は、なるべく多くが鋭角三角形になるように、かつ、線分どうしが交わらないようにする。ドロネー三角形のアルゴリズムと同様である。 \\
    \hline
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/pattern_rinkaku.html}{全体の輪郭} & 表示中の全点の重心からある点からスタートして結果的に全点をむすんでできる閉領域（図形）生成する。 \\
    \hline
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/pattern_wagomu.html}{輪ゴムかける} & 表示中の全点を内部に含む最小の凸多角形（つまり凸包）を生成する \\
    \hline
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/pattern_uzumaki.html}{うずまき} & 表示中の全点の重心から最も遠い点から、渦をまくように点同士を一筆書きしてゆく。 \\
    \hline
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/pattern_kizaminori.html}{きざみのり} & 表示中の各点において自身から最も近い点とペアをなすよう結ぶ。ペア形成の順序は、すべての2点の組み合わせのうちもっとも距離の近い2点同士から結んでゆき、必ずどの点も１ペアのみ形成するようにする。\\
    \hline
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/pattern_yokoame.html}{横雨} & 表示中の各点において自身ともっとも画面上での縦の位置が近い点同士とペアをなすよう結ぶ。ペア形成の順序は、すべての2点の組み合わせのうちもっとも縦位置の近い2点同士から結んでゆき、必ずどの点も１ペアのみ形成するようにする。\\
    \hline
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/pattern_ame.html}{雨} & 表示中の各点において自身ともっとも画面上での横の位置が近い点同士とペアをなすよう結ぶ。ペア形成の順序は、すべての2点の組み合わせのうちもっとも横位置の近い2点同士から結んでゆき、必ずどの点も１ペアのみ形成するようにする。 \\
    \hline
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/pattern_randomchikai.html}{ランダム一筆がき（近）} & 表示中全点からランダムに一点選んで開始点とし、そこからもっとも近い点と結び、次にその点からもっとも近い点をむすび、というふうに一筆書きしてゆく。 \\
    \hline
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/pattern_randomtooi.html}{ランダム一筆がき（遠）} & 表示中全点からランダムに一点選んで開始点とし、そこからもっとも遠い点と結び、次にその点からもっとも遠い点をむすび、というふうに一筆書きしてゆく。\\
    \hline
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/pattern_kawa.html}{川} & 表示中全点からランダムで一点を選び、そこから本流から支流へと分岐してゆく川のように、すべての孤立点がなくなるまで結ぶ。 \\
    \hline
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/pattern_hitofudeyoko.html}{左から右に一筆がき} & 表示中全点からもっとも左にある点から、画面上で横位置がもっとも近い点を順に一筆書きでむすんでゆく。 \\
    \hline
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/pattern_hitofudetate.html}{上から下に一筆がき} & もっとも上にある点から、画面上で縦位置がもっとも近い点を順に一筆書きでむすんでゆく。 \\
    \hline
  \end{tabularx}
  \end{center}
\end{table}
...
補助線スタイルの一覧を\autoref{table:hojosen_type}と\autoref{fig:hojosen_styles1}・\autoref{fig:hojosen_styles2}に示す。
  \autoref{fig:hojosen_styles1}・\autoref{fig:hojosen_styles2}はすべて、同じ補助線パタン・フレームで統一し、補助線スタイルのみ変えてある。
それは、\autoref{fig:hojosen_styles1}の最上段の「デフォルト」スタイルからわかるように、「両側頭と胸骨」「右側の肩と足と胸骨」「左側の肩と足と胸骨」という3つの三角形を作るような補助線パタンで統一してある。
\autoref{table:hojosen_type}・\autoref{fig:hojosen_styles1}・\autoref{fig:hojosen_styles2}は、各補助線スタイルの事例を動画で確認できるよう、動画へのリンクが貼ってある。
クリックしてリンク先に飛び、実際の動画を確認してほしい。
...
\begin{table}[htbp]
  ...
  \bf スタイル名 & \bf 説明 \\
  \hline
  \href{https://takahitohoriuchi.github.io/hj-playground_gallery/style_a.html}{\textbf{デフォルト}} & 各線分IJ \\
  \href{https://takahitohoriuchi.github.io/hj-playground_gallery/style_b.html}{\textbf{線延長}} & 各線分IJを両端に1倍ずつ延長 \\
  \href{https://takahitohoriuchi.github.io/hj-playground_gallery/style_c.html}{\textbf{線延長10倍}} & 各線分IJを両端に5倍ずつ延長\\
  \href{https://takahitohoriuchi.github.io/hj-playground_gallery/style_d.html}{\textbf{外接円}} & 各△IJKの外接円 \\
  \href{https://takahitohoriuchi.github.io/hj-playground_gallery/style_e.html}{\textbf{内接円}} & 各△IJKの内接円 \\
  \href{https://takahitohoriuchi.github.io/hj-playground_gallery/style_f.html}{\textbf{外\&内接円}} & 各△IJKの外接円と内接円 \\
  \href{https://takahitohoriuchi.github.io/hj-playground_gallery/style_g.html}{\textbf{外接円+デフォルト}} & 各△IJKとその外接円 \\
  \href{https://takahitohoriuchi.github.io/hj-playground_gallery/style_h.html}{\textbf{内接円+デフォルト}} & 各△IJKとその内接円 \\
  \href{https://takahitohoriuchi.github.io/hj-playground_gallery/style_i.html}{\textbf{外\&内接円+デフォルト}} & 各△IJKとその外接円と内接円 \\
  \href{https://takahitohoriuchi.github.io/hj-playground_gallery/style_j.html}{\textbf{注視点からの円}} & 各△IJOの外接円（Oはカメラ注視点） \\    
  \href{https://takahitohoriuchi.github.io/hj-playground_gallery/style_k.html}{\textbf{大三角}} & 各△IJKを3倍拡大し重心をOに固定で描く \\    
  \hline
  \end{tabular}
  \end{center}
\end{table}
...
\begin{figure}[htbp]    
  ...
  % デフォルト
  \begin{center}    
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/style_a.html}{\includegraphics[width=\linewidth]{./images/hojosen_style_default.pdf}}
  \end{center}
  \vspace{-1.6em}    
  % 線延長
  \begin{center}    
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/style_b.html}{\includegraphics[width=\linewidth]{./images/hojosen_style_encho.pdf}}
  \end{center}
  \vspace{-1.6em}    
  % 線延長10倍
  \begin{center}    
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/style_c.html}{\includegraphics[width=\linewidth]{./images/hojosen_style_10encho.pdf}}
  \end{center}
  \vspace{-1.6em}    
  % 外接円
  \begin{center}    
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/style_d.html}{\includegraphics[width=\linewidth]{./images/hojosen_style_gaisetsu.pdf}}
  \end{center}
  \vspace{-1.6em}    
  % 内接円  
  \begin{center}    
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/style_e.html}{\includegraphics[width=\linewidth]{./images/hojosen_style_naisetsu.pdf}}
  \end{center}
  \vspace{-1.6em}    
  % 内あんど外接円  
  \begin{center}    
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/style_f.html}{\includegraphics[width=\linewidth]{./images/hojosen_style_naigai.pdf}}
  \end{center}        
  \caption{補助線スタイル一覧（その1）}          
  \label{fig:hojosen_styles1}
\end{figure}
...
\begin{figure}[htbp]    
  ...
  % 外接円+デフォルト
  \begin{center}    
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/style_g.html}{\includegraphics[width=\linewidth]{./images/hojosen_style_gaidef.pdf}}
  \end{center}
  \vspace{-1.6em}    
  % 内接円+デフォルト
  \begin{center}    
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/style_h.html}{\includegraphics[width=\linewidth]{./images/hojosen_style_naidef.pdf}}
  \end{center}
  \vspace{-1.6em}    
  % 内外接円+デフォルト
  \begin{center}    
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/style_i.html}{\includegraphics[width=\linewidth]{./images/hojosen_style_naigaidef.pdf}}
  \end{center}
  \vspace{-1.6em}    
  % 注視点からの円
  \begin{center}    
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/style_j.html}{\includegraphics[width=\linewidth]{./images/hojosen_style_chushien.pdf}}
  \end{center}
  \vspace{-1.6em}    
  % 大三角
  \begin{center}    
    \href{https://takahitohoriuchi.github.io/hj-playground_gallery/style_k.html}{\includegraphics[width=\linewidth]{./images/hojosen_style_daisankaku.pdf}}
  \end{center}          
  \caption{補助線スタイル一覧（その2）}          
  \label{fig:hojosen_styles2}
\end{figure}
...
% 音節に分けて書くと、「音節ごとの再生」「音節ごとのからだメタ認知」の機能も自動で開放される。
\subsection{からだメタ認知をする}

ユーザには、鑑賞体験をからだメタ認知し、からだメタ認知欄に記述することを促す。
...
ユーザには表情図形・オノマトペ・からだメタ認知の３つを１つの\textbf{表情エントリ}としてセットで保存することを促す。
...
主にもちいたJavaScriptライブラリを\autoref{table:libraries}に示す\footnote{
  研究1の物語の\ref{sec:monowotool}節で登場したProcessingのJavascript版である。
}。
\begin{table}[t]
  \begin{center}
